            ...
            <div class="login">
                ...
                <?php
                    ...
                    if(isset($_POST['connexion']))
                    {
                        ...
                        include 'BDD.php';
                        $user2= new Bdd("","","","");   
                        $login = $_SESSION['loginConnexion'];
                        $mdp  = $_SESSION['motDePasseConnexion'];
                        $user2 -> Connexion("127.0.0.1","trackinggps","Root","Root");
                        $_SESSION['user'] = $user2 -> Autorisation("Arthur","TEST","connexion",$login,$mdp);
